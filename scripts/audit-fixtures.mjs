...
const fixtures = [
  ...
  ["frontend-smoke-es-de", "scripts/audit-descriptor-relationships.mjs", "fixtures/frontend-smoke/es-de/roms/psx"],
  ["frontend-smoke-launchbox", "scripts/audit-launchbox-paths.mjs", "fixtures/frontend-smoke/launchbox/Data"],
  ["frontend-smoke-romm", "scripts/audit-romm-slugs.mjs", "fixtures/frontend-smoke/romm"],
  ["frontend-smoke-pegasus", "scripts/audit-pegasus-assets.mjs", "fixtures/frontend-smoke/pegasus"],
