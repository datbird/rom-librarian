...
const summary = {
  ...
  fixture_audits: 24,
  mutating_applicators: ["apply:m3u-case-fixes", "apply:cue-case-fixes", "apply:gdi-case-fixes", "apply:missing-m3u-playlists", "apply:empty-folder-cleanup", "apply:orphaned-media-quarantine"],
